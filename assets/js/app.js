...
const translations = {
  en: {
    ...
    roadKicker:'THE ROAD TO 21 MILLION', roadTitle:'From the farm<br>to completely unreasonable dreams.', roadBody:'This is supply progress, not a price target. Every real QUQN minted simply moves the little coq further along the road.', roadLoading:'Loading current mint progress…',
    roadMilestoneFarm:'THE FARM', roadMilestoneStart:'START', roadMinted:'minted',
  ...
  fr: {
    ...
    roadKicker:'LA ROUTE VERS 21 MILLIONS', roadTitle:'De la ferme<br>aux rêves complètement déraisonnables.', roadBody:'Il s’agit de la progression du mint, pas d’un objectif de prix. Chaque QUQN réellement minté fait avancer le petit coq sur sa route.', roadLoading:'Chargement de la progression du mint…',
    roadMilestoneFarm:'LA FERME', roadMilestoneStart:'DÉPART', roadMinted:'mintés',
  ...
  ko: {
    ...
    roadMilestoneFarm:'농장', roadMilestoneStart:'시작', roadMinted:'민트됨',
  ...
  pt: {
    ...
    roadMilestoneFarm:'A FAZENDA', roadMilestoneStart:'INÍCIO', roadMinted:'mintados',
  ...
  es: {
    ...
    roadMilestoneFarm:'LA GRANJA', roadMilestoneStart:'INICIO', roadMinted:'minteados',
  ...
  ja: {
    ...
    roadMilestoneFarm:'農場', roadMilestoneStart:'開始', roadMinted:'ミント済み',
  ...
  ar: {
    ...
    roadMilestoneFarm:'المزرعة', roadMilestoneStart:'البداية', roadMinted:'تم سكّها',
  ...
  zh: {
    ...
    roadMilestoneFarm:'农场', roadMilestoneStart:'起点', roadMinted:'已铸造',
...
window.quqnRoadText = key => (translations[lang] || translations.en)[key] ?? translations.en[key];
