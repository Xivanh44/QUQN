...
const translations = {
  en: {
    ...
    communityTitle:'A meme needs people, not promises.', communityBody:'Follow QUQN on X for memes, Coop updates and on-chain milestones. Telegram will join the farm later.',
  ...
  fr: {
    ...
    communityTitle:'Un meme a besoin de gens, pas de promesses.', communityBody:'Retrouve QUQN sur X pour les memes, les mises à jour de The Coop et les étapes on-chain. Telegram viendra plus tard.',
...
function setupSocial(){if(!cfg)return;const s=cfg.social||{},xUrl=s.x||'https://x.com/QUQNbtc';safe('#socialButtons',e=>e.innerHTML=`<a class="btn dark" href="${xUrl}" target="_blank" rel="noopener">𝕏 Follow @QUQNbtc</a>`+(s.telegram?`<a class="btn dark" href="${s.telegram}" target="_blank" rel="noopener">✈ Join Telegram</a>`:`<span class="btn dark disabled">✈ Telegram — coming soon</span>`))}
